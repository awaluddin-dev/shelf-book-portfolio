...
import { Terminal, Github, Linkedin, PenTool, Mail, BookOpen, Download } from "lucide-react";

export function HeroSection({ pd, _gh, isLoading, _isDark, activeMetrics, renderIcon, setShowInquiryModal, triggerToast }: any) {
  return (
    <>
