    ...
    <AdminCrudTable
      ...
      onBeforeSave={(formData) => {
        ...
        return {
          ...
          connections:
            typeof formData.connections === "string"
      ...
      renderForm={(formData, setFormData) => (
        <>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label
                htmlFor="adm-skill-category"
                className="text-xs font-mono text-neu-text-muted"
              >
                Proficiency Category
              </label>
              <select
                id="adm-skill-category"
                required
                ...
                className="w-full px-4 py-2.5 rounded-xl glass-card-inset text-sm font-medium border border-white/5 focus:border-neu-accent outline-none appearance-none bg-black/40"
              >
            ...
            <div className="space-y-1">
              <label
                htmlFor="adm-skill-proficiency"
                className="text-xs font-mono text-neu-text-muted"
              >
                Specific Skill
              </label>
              <select
                id="adm-skill-proficiency"
                value={formData.proficiencySkillId || ""}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    proficiencySkillId: e.target.value,
                  })
                }
                className="w-full px-4 py-2.5 rounded-xl glass-card-inset text-sm font-medium border border-white/5 focus:border-neu-accent outline-none appearance-none bg-black/40"
              >
                ...
                {(
                  proficiencies.find((p) => p.id === formData.categoryId)
                    ?.skills || []
                ).map((s: any) => (
