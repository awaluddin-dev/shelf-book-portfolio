...
function MovingNode({
  ...
  const HOT_FILL_VALUES = `${initialColor}; ${initialColor}; #00FF87; #00FF87; ${initialColor}; ${initialColor}`;
  const HOT_KEY_TIMES = "0; 0.35; 0.45; 0.55; 0.65; 1";
  const textYNum = Number(textY);

  return (
    <g
      style={{ "--node-color": initialColor } as React.CSSProperties}
      ...
      if (nodes.length > 0) {
        ...
        if (circuitSvg) {
          if (processorHitColor) {
            circuitSvg.style.setProperty(
              "--processor-color",
              processorHitColor,
            );
            circuitSvg.style.setProperty(
              "--processor-glow",
              `drop-shadow(0 0 30px ${processorHitColor})`,
            );
          } else {
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <g id="circuit-quadrant">
            ...
            {/* Chip pins */}
            <path
              d="M 80,15 L 95,15 M 80,35 L 95,35 M 80,55 L 95,55 M 80,75 L 95,75"
              stroke="currentColor"
              strokeWidth="2"
            />
            <path
              d="M 15,80 L 15,95 M 35,80 L 35,95 M 55,80 L 55,95 M 75,80 L 75,95"
              stroke="currentColor"
              strokeWidth="2"
            />
            ...
            <path
              d="M 95,15 L 150,15 L 200,65 L 350,65 L 400,115 L 500,115"
              fill="none"
              stroke="currentColor"
              strokeWidth="2.5"
            />
            <path
              d="M 15,95 L 15,150 L 65,200 L 65,350 L 115,400 L 115,500"
              fill="none"
              stroke="currentColor"
              strokeWidth="2.5"
            />
            ...
            <g>
              ...
              {/* Standard Traces */}
              <path
                d="M 95,35 L 130,35 L 180,85 L 280,85 L 330,135 L 500,135"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
              />
              <path
                d="M 95,55 L 110,55 L 160,105 L 250,105 L 300,155 L 450,155 L 500,205"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
              />
              <path
                d="M 95,75 L 105,75 L 140,110 L 220,110 L 270,160 L 350,160 L 400,210 L 500,210"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              />
              ...
              <path
                d="M 35,95 L 35,130 L 85,180 L 85,280 L 135,330 L 135,500"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
              />
              <path
                d="M 55,95 L 55,110 L 105,160 L 105,250 L 155,300 L 155,450 L 205,500"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              />
              <path
                d="M 75,95 L 75,105 L 110,140 L 110,220 L 160,270 L 160,350 L 210,400 L 210,500"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
              />
              ...
              <path
                d="M 200,200 L 250,250 L 500,250"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                strokeOpacity="0.9"
              />
              <path
                d="M 190,210 L 240,260 L 500,260"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeOpacity="0.7"
              />
              <path
                d="M 180,220 L 230,270 L 500,270"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeOpacity="0.7"
              />
              <path
                d="M 170,230 L 220,280 L 500,280"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.5"
                strokeOpacity="0.9"
              />
              <path
                d="M 160,240 L 210,290 L 500,290"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeOpacity="0.7"
            ...
            <path
              d="M 400,320 L 400,280 L 450,230 L 500,230"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeDasharray="3 3"
        ...
        <rect
          ...
          style={{
            transition:
              "stroke 0.3s ease-out, fill 0.3s ease-out, filter 0.3s ease-out",
      ...
      >
        ...
        {/* Quadrant 3: Bottom Right (emerald — bottom-area nodes) */}
        <MovingNode
          label="Redis"
          textY="15"
          initialColor="#10b981"
        ...
        {/* Quadrant 4: Bottom Left (purple — diagonal bus nodes) */}
        <MovingNode
          label="OAuth"
          textY="15"
          initialColor="#8b5cf6"
