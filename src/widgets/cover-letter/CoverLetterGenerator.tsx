...
export function CoverLetterGenerator({ onClose }: { onClose?: () => void }) {
  const { 
  ...
  const handleConnectSocials = () => {
    ...
    onClose?.();
    setTimeout(() => {
      document.getElementById('connection-terminal')?.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }, 100);
  };
  ...
  return (
    <section className="mx-auto w-full max-w-2xl space-y-4">
      {/* Header */}
      <div>
        <h2 className="text-lg font-semibold text-neu-text">Cover Letter Generator</h2>
        <p className="mt-1 text-sm text-neu-text-muted">
          Paste a job description and get a tailored cover letter based on my actual experience.
        </p>
      </div>
            ...
            <div className="border-t border-neu-accent/20 bg-white/5 print-hide">
              <div className="px-4 py-3 border-b border-neu-accent/10">
                ...
                >
                  ...
                  <ChevronIcon className={`h-3 w-3 text-neu-text-muted transition-transform duration-200 ${isJdExpanded ? 'rotate-180' : ''}`} />
                </button>
              ...
              <div className="px-4 py-4 bg-neu-bg/50">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-center leading-tight">Draft Inquiry</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-center leading-tight text-neu-text-muted">Schedule Call</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-center leading-tight text-neu-text-muted">Save PDF</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-center leading-tight text-neu-text-muted">Connect</span>
                  </button>
                </div>
                ...
                <div className="mt-2 pt-2 border-t border-white/5">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-center leading-tight text-neu-text-muted">Try Another Job Desk</span>
                  </button>
                </div>
              </div>
            </div>
