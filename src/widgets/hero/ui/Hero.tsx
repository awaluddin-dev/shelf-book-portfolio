...
import { BookOpen, Download, Terminal, PenTool, Mail, Printer } from "lucide-react";
    ...
    <>
      <header className="relative z-10 min-h-[70vh] lg:min-h-[80vh] flex flex-col justify-center pt-6 md:pt-9 lg:pt-12 pb-16 md:pb-20 lg:pb-24 w-full overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 mt-2 md:mt-4 lg:mt-0">
          {isLoading ? (
            <div className="flex flex-col lg:flex-row justify-between items-stretch gap-12 animate-pulse w-full">
              <div className="w-full lg:w-[32%] xl:w-[30%] flex flex-col py-2 min-h-[350px]">
                <div className="w-full h-full bg-neu-accent/5 rounded-3xl border border-white/5"></div>
              </div>
              <div className="w-full lg:w-[32%] xl:w-[30%] flex flex-col py-2 min-h-[350px]">
                <div className="w-full h-full bg-neu-accent/5 rounded-3xl border border-white/5"></div>
              </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-y-3 md:gap-y-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.1 }}
                      className="text-sm md:text-base font-display font-bold text-neu-accent transition-colors duration-300"
                    >
