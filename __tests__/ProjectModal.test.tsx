...
jest.mock("@/shared/ui/MermaidDiagram", () => () => (
  <div data-testid="mermaid-diagram" />
));
jest.mock("@/entities/project/ui/ProjectLifecycleTracker", () => () => (
  <div data-testid="project-lifecycle-tracker" />
));
jest.mock("@/entities/project/ui/ProjectArchitectureDiagram", () => () => (
  <div data-testid="project-architecture-diagram" />
));
...
describe("ProjectModal", () => {
  ...
  const defaultProject = {
    ...
    markdown: "# Specs",
    systemArchitectures: [
      { imageUrl: "arch.png", description: "Architecture" },
    ],
  ...
  it("navigates projects when paginating past bounds", () => {
    ...
    expect(mockSetSelectedProject).toHaveBeenCalledWith(
      defaultStoreState.dynamicProjects[2],
    ); // wraps to last
    ...
    expect(mockSetSelectedProject).toHaveBeenCalledWith(
      defaultStoreState.dynamicProjects[1],
    );
  });
